...
public class PhaseScript : MonoBehaviour {
    ...
    private TrailSpawner[] _trailSpawners;
    ...
    private void Start() {
        ...
        _trailSpawners = new TrailSpawner[portals.Length];

        for (int i = 0; i < portals.Length; i++)
            _trailSpawners[i] = portals[i].GetComponent<TrailSpawner>();
        ...
        switch (_phase) {
            ...
            case Phase.Begin:
                ...
                if (Input.GetKey(KeyCode.B)) {
                    ...
                    foreach (var trailSpawner in _trailSpawners)
